...
.DateInput__withCaret:aSelect-inputfter,
...
.DateInput_input {
  opacity: 0;
  position: absolute;Select-input
  top: 0;
  left: 0;
  border: 0;
  height: 100%;
...
.uploadHoverable:hover{
  cursor: pointer;
}


.uploadHoverable:hover button.ui.circular.primary.button {
...
.field.error .Select-placeholder{
  background: #fff6f6;
  border-color: #e0b4b4;
  color: #9f3a38;
  border-radius: '';
...
i.question.circular.icon:hover {
  background-color: #333d68!important;
  color: #fff!important;
}

// Upload
.uploadHoverable:hover .uploadable-dropdown-item{
  background-color: rgba(0,0,0,.05)!important;
}

.upload-document-progress {
  -webkit-transition: height .8s; /* Safari */
...
.ui.steps .step.active .content .description {
